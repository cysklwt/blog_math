...
> [!example] 
> 1. 化为行阶梯矩阵： ![qici1](https://animed-blog.oss-cn-wuhan-lr.aliyuncs.com/qici1.png)
> 2. 一个阶梯找一列（多种选法）： ![qici2](https://animed-blog.oss-cn-wuhan-lr.aliyuncs.com/qici2.png)
> 3. 剩下的列为自由变量，并填入最简单的矩阵：![qici3](https://animed-blog.oss-cn-wuhan-lr.aliyuncs.com/qici3.png)
> 4. 与任意行进行内积为0，求得剩下的位置：![qici4](https://animed-blog.oss-cn-wuhan-lr.aliyuncs.com/qici4.png)
> 
> 此为所求解。