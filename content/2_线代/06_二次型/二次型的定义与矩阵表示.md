...
$n$ 元变量 $x_{1}, x_{2}, \cdots , x_{n}$ 的二次齐次多项式 ![quad_form_def](https://animed-blog.oss-cn-wuhan-lr.aliyuncs.com/quad_form_def.png) 称为： $n$ 元二次型，简称**二次型**。
...
因为 $x_{i}x_{j} = x_{j}x_{i}$ ，若令 $a_{ij} = a_{ji}$ ，则 $2a_{ij}x_{i}x_{j} = a_{ij}x_{i}x_{j} + a_{ji}x_{j}x_{i}$ ，于是 ![quad_form_def_2](https://animed-blog.oss-cn-wuhan-lr.aliyuncs.com/quad_form_def_2.png)
...
> [!example] 
> ![quad_visual](https://animed-blog.oss-cn-wuhan-lr.aliyuncs.com/quad_visual.png)
