...
$$
\begin{bmatrix} \boldsymbol{D} & \boldsymbol{B}\\\boldsymbol{C} & \boldsymbol{0}\end{bmatrix}^{-1}=
\begin{bmatrix} \boldsymbol{0} & \boldsymbol{C}^{-1}\\ \boldsymbol{B}^{-1} & -\boldsymbol{B}^{-1}\boldsymbol{D}\boldsymbol{C}^{-1}\end{bmatrix}
$$