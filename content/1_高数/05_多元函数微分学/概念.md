...
> - 除 [[计算#洛必达法则|洛必达法则]]和 [[单调有界准则]] 以外，可照搬一元函数求极限的方法求二重极限，如
> 	- 唯一性；
> 	- 局部有界性；
> 	- 局部保号性；
> 	- 运算规则；
...
![deriv_hill](https://animed-blog.oss-cn-wuhan-lr.aliyuncs.com/deriv_hill.png)

偏导数只考虑沿 $x$ 轴或沿 $y$ 轴的变化率，是方向导数的特殊情况。

![partial_deriv](https://animed-blog.oss-cn-wuhan-lr.aliyuncs.com/partial_deriv.png)
...
![multi_deriv](https://animed-blog.oss-cn-wuhan-lr.aliyuncs.com/multi_deriv.png)
...
> - 一元函数和多元函数在极限存在、连续、可导、可微的联系与区别：![multi_comp](https://animed-blog.oss-cn-wuhan-lr.aliyuncs.com/multi_comp.png)
