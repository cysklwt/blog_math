...
> [!note] 
> ![multi_chain](https://animed-blog.oss-cn-wuhan-lr.aliyuncs.com/multi_chain.png)
...
> [!note] 
> - 全导数：$z=f(u,v), u=\phi(t), v=\psi(t)$，则 $z=f[\phi(t), \psi(t)]$ 且 $$\frac{\mathrm{d}z}{\mathrm{d}t} = \frac{\partial z}{\partial u}\frac{\mathrm{d} u}{\mathrm{d} t} + \frac{\partial z}{\partial v}\frac{\mathrm{d} v}{\mathrm{d} t}$$ ![multi_comp2](https://animed-blog.oss-cn-wuhan-lr.aliyuncs.com/multi_comp2.png)
