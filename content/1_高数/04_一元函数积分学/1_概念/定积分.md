...
若上一步求得的极限存在，且与分割方式以及 $\delta_k$ 的取法无关，则称：**函数 $f(x)$ 在区间 $[a,b]$ 上可积**。

$$\int_a^b f(x) \mathrm{d}x$$

### 几何意义

1. 定积分 $\int^{b}_{a} f(x) \mathrm{d}x$ 就是计算曲线、直线 $x=a$ 、直线 $x=b$ 、x 轴围成的面积。
...
> [!tip] 
>
> 事实上，只要区间内非负的 $f(x)$ 不恒等于零，那么其积分**一定大于 0**。
...
![int 4](https://animed-blog.oss-cn-wuhan-lr.aliyuncs.com/int_chrct5.png)
